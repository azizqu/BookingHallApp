...
namespace BookingHallAppDraft.Models.Database
{
    public class MyDB
    {
        ...
        private MyDB()
        {
            ...
            _connection = new SqlConnection(@"Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=BookingHalls;Data Source=LENOVO-PC\MSSQLSERVERNEW14;MultipleActiveResultSets=true");
        }
